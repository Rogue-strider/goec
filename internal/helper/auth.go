...
func (a Auth) CreateHashedPassword(p string) (string, error) { //accept some kind of plain text and return hashed password
...
func (a Auth) VerifyToken(t string) (domain.User, error) {
	//token will look like this == Bearer t423456789ertyu so we are not interested in thing before space i.e "Bearer "
