...
func (s UserService) Signup(input dto.UserSignup) (string, error) { //any is alias of an empty interface
...
func (s UserService) VerifyCode(id uint, code int) error {
	...
	if user.Code != strconv.Itoa(code) {
...
func (s UserService) GetOrders(u domain.User) ([]interface{}, error) { //[]interface{} = a slice that can contain values of different types
	return nil, nil
}

func (s UserService) GetOrderById(u domain.User) ([]interface{}, error) {
	return nil, nil
}
